...
from common import GridTask, TaskInfo, InputFile, OutputFile, GridTask, Argument, TaskGroup
...
if __name__ == '__main__':
	...
	taskList = mySession.query(GridTask.GridTask).filter(GridTask.GridTask.taskGroupID>=minElement and GridTask.GridTask.taskGroupID<=maxElement)
